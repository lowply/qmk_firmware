...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        MO(1),    KC_NO,   KC_NO,  KC_LALT,  KC_LGUI,
        // left bottom
                KC_ESC,    KC_NO,
                           KC_NO,
        KC_SPC, KC_LANG2,  KC_NO,

        // right hand
        KC_7,  KC_8,   KC_9,    KC_0,    KC_MINS,   KC_EQL,    KC_BSPC,
        KC_G,  KC_Y,   KC_U,    KC_I,    KC_O,      KC_P,      KC_BSLS,
               KC_H,   KC_J,    KC_K,    KC_L,      KC_SCLN,   KC_ENT,
        KC_B,  KC_N,   KC_M,    KC_COMM, KC_DOT,    KC_SLSH,   KC_RSFT,
                       KC_RGUI, KC_QUOT, KC_LBRC,   KC_RBRC,   KC_GRV,
        // right bottom
        KC_LEFT, KC_RIGHT,
        KC_UP,
...
[SYMB] = LAYOUT_ergodox(
        ...
        KC_PGUP, SGUI(KC_LBRC), KC_TRNS, KC_TRNS, SGUI(KC_RBRC),  KC_TRNS, KC_TRNS,
